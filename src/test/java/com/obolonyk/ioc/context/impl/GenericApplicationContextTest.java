...
import com.obolonyk.entity.DefaultUserService;
import com.obolonyk.entity.MailService;
...
public class GenericApplicationContextTest {
    ...
    public void testCreateBeans() {
        ...
        BeanDefinition beanDefinitionMailService = new BeanDefinition("mailServicePOP", "com.obolonyk.entity.MailService");
        beanDefinitionMap.put("mailServicePOP", beanDefinitionMailService);
        BeanDefinition beanDefinitionUserService = new BeanDefinition("userService", "com.obolonyk.entity.DefaultUserService");
    ...
    public void testCreateBeansWithWrongClass() {
        Map<String, BeanDefinition> beanDefinitionMap = new HashMap<>();
        BeanDefinition errorBeanDefinition = new BeanDefinition("mailServicePOP", "com.obolonyk.entity.TestClass");
    ...
    public void testInjectValueDependencies() {
        ...
        BeanDefinition popServiceBeanDefinition = new BeanDefinition("mailServicePOP", "com.obolonyk.entity.MailService");
        ...
        BeanDefinition imapServiceBeanDefinition = new BeanDefinition("mailServiceIMAP", "com.obolonyk.entity.MailService");
    ...
    public void testInjectRefDependencies() {
        ...
        BeanDefinition userServiceBeanDefinition = new BeanDefinition("userService", "com.obolonyk.entity.DefaultUserService");
